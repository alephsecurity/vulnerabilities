...
vulnerable: 
    - Android 7.1.1 N6F26Y and earlier (Nexus 6).
    - Bootloader moto-msm8952-B1.05 on Moto G4. Other versions are unconfirmed.
...
A root exploit for Nexus 6 is demonstrated]. PoC is available at our [GitHub research repo](https://github.com/alephsecurity/research/tree/master/initroot). 
