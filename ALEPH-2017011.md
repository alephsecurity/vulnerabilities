...
cve: 'CVE-2016-10277'
title: 'Google Nexus 6 Motorola Bootloader Kernel Command-line Injection Secure Boot Bypass'
references:
...
---
Nexus 6's Motorola `ABOOT` (Applications Bootloader) contains several arguments that can be controlled through the fastboot interface, even if the bootloader is locked:
