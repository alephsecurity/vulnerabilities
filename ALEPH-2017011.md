...
timeline:
    ...
    - type: 'products-add'
      date: '2017-06-12'
      arg: 'Moto G3, Moto G4 Play, Moto G5 Play'
...
product: 
    ...
    - Moto G5
    - Moto G4
    - Moto G5 Play ([community reported](https://github.com/alephsecurity/initroot/issues/1))
    - Moto G4 Play ([community reported](https://twitter.com/utoprime/status/873941023050919936))
    - Moto G3 ([commnity reported](https://twitter.com/asiekierka/status/873467107090075648))
