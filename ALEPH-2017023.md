...
severity: moderate
mitigation: 'Patch has been committed to the mainline tree, available in the 4.12-rc2 release. Patch has also been queued on the 3.18, 4.11, 4.4, 4.9 stable trees.'
title: 'Linux lp.c Out-of-Bound Write via Kernel Command-line'
---
